...
export async function updateRecurringThisAndFuture(appointmentId, appointment) {
  const response = await fetch(`/api/appointments/${encodeURIComponent(appointmentId)}/this-and-future`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify(appointment)
  });
