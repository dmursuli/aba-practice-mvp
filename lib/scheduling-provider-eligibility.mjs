...
export function serviceCodesEligibleForProviderRole(role) {
  return SCHEDULING_SERVICE_CODES.filter((serviceCode) => (
    providerRoleIsEligibleForService(role, serviceCode)
  ));
}
